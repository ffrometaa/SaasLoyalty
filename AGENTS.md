...
- `createServiceRoleClient()` is allowed in route handlers **and Server Components** that perform admin operations (cross-tenant reads/writes, bypassing RLS intentionally) — document the reason with a comment
