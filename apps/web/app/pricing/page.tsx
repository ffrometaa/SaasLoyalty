      ...
      <div className="pt-16">
        ...
        <section className="py-16 px-6" style={{ background: '#0a0a0f' }}>
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display font-bold text-white text-2xl text-center mb-10">Everything included</h2>
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-4 px-6 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                <div className="text-white/40 text-xs font-semibold tracking-wide uppercase">Feature</div>
