  ...
  offers: [
    {
      ...
      description: 'For businesses getting started. Up to 800 members, 3 campaigns/month.',
      url: 'https://loyalbase.dev/pricing',
    },
    {
      '@type': 'Offer',
...
export default async function PricingPage() {
  ...
  const TABLE_ROWS = [
    ...
    { feature: 'Members', starter: '800', pro: '2,000', scale: 'Unlimited' },
    { feature: 'Campaigns / month', starter: '3', pro: '10', scale: 'Unlimited' },
