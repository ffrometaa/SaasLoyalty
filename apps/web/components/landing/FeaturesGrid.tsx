...
const FEATURES = [
  {
    ...
    body: "Your customers use YOUR app with YOUR logo. Not ours. White-label loyalty that looks like you built it from scratch.",
  },
  {
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    body: 'When a customer goes 25 days without visiting, LoyaltyOS automatically sends personalized campaigns to bring them back.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    body: 'See your best customers, busiest hours, top products, and at-risk members — all in one dashboard built for business owners.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    body: 'Fully customizable points per dollar, tier levels (Bronze, Silver, Gold, Platinum), and reward catalog. Your rules, your brand.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    body: 'Reach members the moment it matters. Birthday rewards, double-points campaigns, reactivation sequences — all automated.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    body: 'Connect with Square, Vagaro, Acuity and more. Members book appointments and earn points in the same flow.',
  },
];
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div
          ...
          style={{ opacity: 0, transform: 'translateY(20px)', transition: 'opacity 0.6s, transform 0.6s' }}
        >
          <p className="text-white/50 text-lg">LoyaltyOS automates what the best brands do manually</p>
        </div>
